                ...
                <div class="panel panel-bordered panel-primary">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="text" class="form-control" id="title" value="{{$Category_first["name"]}}" name="name" placeholder="" value="" >
                            <span>@error('name'){{$message}}@enderror</span>

                            </div>
                        <div class="panel-body">
                            <label>Đường dẫn</label>
                            <input type="text" class="form-control" id="slug" value="{{$Category_first["slug"]}}" name="slug" placeholder="Title" >
                        </div>
                        <div class="panel-body">
                        ...
                        <div class="panel-body">
                            <label>Mô tả</label>
                            <textarea class="form-control" id="desc"  name="desc" placeholder="Title" > {{$Category_first["description"]}}</textarea>
