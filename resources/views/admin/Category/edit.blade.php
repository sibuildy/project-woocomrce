        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="panel panel-bordered panel-primary">
                    ...
                    <form action="/admin/categrories/update" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="panel-body">
                            <label>Tên danh mục</label>

                            <input type="hidden" id="custId" name="id" value="{{ $Category_first['id'] }}">

                            <input type="text" class="form-control" id="title" value="{{ $Category_first['name'] }}"
                        ...
                        <div class="panel-body">
                            ...
                            <input type="text" class="form-control" id="slug" value="{{ $Category_first['slug'] }}"
                                name="slug" placeholder="Title">
                        </div>
                        <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <textarea class="form-control" id="desc" name="desc"
                                placeholder="Title"> {{ $Category_first['description'] }}</textarea>
                            <span>
                                @error('desc')
                                    {{ $message }}
                                @enderror
                                ...
                                <tr role="row">
                                    <td>
                                        @if ($item->image === null)
                                            ...
                                            @endphp
                                        @else
                                            <img src="{{ $item->image->src }}" width="100px" height="auto" alt=""
                                                srcset="">
                                        @endif
